...
public class SimScreenControler {
	...
	private void initialize() throws IOException {
		...
		Planets.add(new Planet(300, new javafx.geometry.Point3D(-750* 5, 0, 0), 1 / .24, 3, neptunematerial));
